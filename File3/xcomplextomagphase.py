...
class xcomplextomagphase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "xcomplextomagphase")
...
def main(top_block_cls=xcomplextomagphase, options=None):
