...
class xcomplextofloat(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "xcomplextofloat")
...
def main(top_block_cls=xcomplextofloat, options=None):
